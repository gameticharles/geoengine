...
Apsis bruteSearchPlanetApsis(Body body, AstroTime startTime) {
  /*
...
Apsis searchPlanetApsis(Body body, dynamic startTime) {
...
Apsis nextPlanetApsis(Body body, Apsis apsis) {
