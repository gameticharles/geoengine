...
abstract class Projection {
  ...
  Projection.init(ProjParams params)
      : projName = params.proj!,
        ...
        ep2 = params.ep2!,
        datum = params.datum!,
        fromGreenwich = params.from_greenwich,
        toMeter = params.to_meter;
  ...
  Point transform(Projection dest, Point point) {
    ...
    if (source.projName == 'longlat') {
      ...
      if (source.toMeter != null) {
        point = Point.withZ(
            x: point.x * source.toMeter!,
            y: point.y * source.toMeter!,
            z: point.z ?? 0.0);
      }
      point = source.inverse(point); // Convert Cartesian to longlat
    }
    if (source.fromGreenwich != null) {
    ...
    if (dest.fromGreenwich != null) {
      point = Point.withZ(
        x: point.x - dest.fromGreenwich!,
        y: point.y,
        z: point.z ?? 0.0,
      );
    }
    ...
    if (dest.projName == 'longlat') {
      ...
      if (dest.toMeter != null) {
        point = Point.withZ(
            x: point.x / dest.toMeter!,
            y: point.y / dest.toMeter!,
            z: point.z ?? 0.0);
      }
    }
